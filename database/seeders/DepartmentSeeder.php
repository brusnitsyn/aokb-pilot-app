...
class DepartmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $departmentsReceives = [
            [ 'name' => 'ГАУЗ АО "Амурская областная клиническая больница"', 'is_receive' => true, 'shortname' => 'ГАУЗ АО "АОКБ"', 'coords' => [127.506377, 50.304888] ], // 31
            [ 'name' => 'ГАУЗ АО "Амурская областная детская клиническая больница"', 'is_receive' => true, 'shortname' => 'ГАУЗ АО "АОДКБ"', 'coords' => [127.545917, 50.268723] ], // 32
            [ 'name' => 'ГАУЗ АО "Амурская областная инфекционная больница"', 'is_receive' => true, 'shortname' => 'ГАУЗ АО "АОИБ"', 'coords' => [127.493337, 50.270679] ], // 33
            [ 'name' => 'ГБУЗ АО "Амурская областная психиатрическая больница"', 'is_receive' => true, 'shortname' => 'ГАУЗ АО "АОПБ"', 'coords' => [127.497969, 50.269779] ], // 34
            [ 'name' => 'Кардиохирургический центр АГМА', 'is_receive' => true, 'shortname' => 'КЦ "АГМА"', 'coords' => [127.544409, 50.265659] ], // 35
            [ 'name' => 'ДНЦ Физиологии и патологии дыхания', 'is_receive' => true, 'shortname' => 'ДНЦ ФПД', 'coords' => [127.519434, 50.262910] ], // 36
        ];
